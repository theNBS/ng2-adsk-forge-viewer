...
describe('ThumbnailComponent', () => {
  ...
  describe('getThumbnail', () => {
    it('no data', () => {
      ...
      when(mockHttpClient.get(anything(), anything())).thenReturn(Observable.of(null));
    ...
    it('data', () => {
      ...
      when(mockHttpClient.get(anything(), anything())).thenReturn(Observable.of(new ArrayBuffer(8)));
      const spy = spyOn(component, 'setImageSrc' as any).and.stub();
